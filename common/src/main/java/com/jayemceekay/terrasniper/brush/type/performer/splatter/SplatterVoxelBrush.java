...
public class SplatterVoxelBrush extends AbstractPerformerBrush {
    ...
    public void handleCommand(String[] parameters, Snipe snipe) {
        ...
        if (firstParameter.equalsIgnoreCase("info")) {
            messenger.sendMessage(ChatFormatting.GOLD + "Splatter Voxel Brush Parameters:");
            messenger.sendMessage(ChatFormatting.AQUA + "/b sv s [n] -- Sets a seed percentage to n (1-9999). 100 = 1% Default is " +
                    "1000.");
            messenger.sendMessage(ChatFormatting.AQUA + "/b sv g [n] -- Sets a growth percentage to n (1-9999). Default is 1000.");
            messenger.sendMessage(ChatFormatting.AQUA + "/b sv r [n] -- Sets a recursion i (1-10).  Default is 3.");
        } else {

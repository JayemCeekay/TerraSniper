...
public class StencilBrush extends AbstractBrush {
    ...
    public void loadProperties() {
        ...
        File dataFolder = new File(TerraSniper.TERRASNIPER_CONFIG_FOLDER.getPath(), "/stencils");
        dataFolder.mkdirs();
    }
    ...
    public void handleCommand(String[] parameters, Snipe snipe) {
        ...
        if (firstParameter.equalsIgnoreCase("info")) {
            ...
            try {
                ...
                File file = new File(TerraSniper.TERRASNIPER_CONFIG_FOLDER.getPath(), "/stencils/" + this.filename + ".vstencil");
                if (file.exists()) {

...
public class SplineBrush extends AbstractPerformerBrush {
    ...
    private final List<SplineBrush.Point> spline = new ArrayList<>();
    private boolean set;
        ...
        if (firstParameter.equalsIgnoreCase("info")) {
            ...
            if (firstParameter.equalsIgnoreCase("ss")) {
                ...
                if (this.endPts.size() == 2 && this.ctrlPts.size() == 2) {
                    if (this.spline(new SplineBrush.Point(this.endPts.get(0)), new Point(this.endPts.get(1)), new com.jayemceekay.terrasniper.brush.type.performer.SplineBrush.Point(this.ctrlPts.get(0)), new com.jayemceekay.terrasniper.brush.type.performer.SplineBrush.Point(this.ctrlPts.get(1)), snipe)) {
                        try {
                            this.render();

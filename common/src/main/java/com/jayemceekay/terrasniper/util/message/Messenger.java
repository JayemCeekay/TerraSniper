...
public class Messenger {
    ...
    public void sendMessage(Component message) {
        this.sender.sendSystemMessage(MutableComponent.create(new LiteralContents(LegacyComponentSerializer.INSTANCE.serialize(message))));
    }

    public void sendMessage(String message) {
        this.sender.sendSystemMessage(MutableComponent.create(new LiteralContents(message)));
    }
}
